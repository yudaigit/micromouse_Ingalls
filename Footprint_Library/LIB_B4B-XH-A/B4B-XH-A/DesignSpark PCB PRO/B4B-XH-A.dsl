...
(library Library_1
	...
	(patternDef "B4BXHA" (originalName "B4BXHA")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 3.725, 0.525) (textStyleRef "Default") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.45 -2.35) (pt 9.95 -2.35) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 9.95 -2.35) (pt 9.95 3.4) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 9.95 3.4) (pt -2.45 3.4) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.45 3.4) (pt -2.45 -2.35) (width 0.1))
		)
		(layerContents (layerNumRef 18)
