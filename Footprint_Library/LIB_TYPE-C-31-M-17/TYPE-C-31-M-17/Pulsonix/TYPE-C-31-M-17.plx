...
(library Library_1
	...
	(patternDef "TYPEC31M17" (originalName "TYPEC31M17")
		...
		(layerContents (layerNumRef 28)
			(line (pt -4.47 2.75) (pt 4.47 2.75) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 4.47 2.75) (pt 4.47 -4.05) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 4.47 -4.05) (pt -4.47 -4.05) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -4.47 -4.05) (pt -4.47 2.75) (width 0.025))
		)
	...
	(compDef "TYPE-C-31-M-17" (originalName "TYPE-C-31-M-17") (compHeader (numPins 10) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "https://datasheet.lcsc.com/szlcsc/1903211732_Korean-Hroparts-Elec-TYPE-C-31-M-17_C283540.pdf")
		(attr "<Component Height>" "3.26")
		(attr "<STEP Filename>" "TYPE-C-31-M-17.stp")
		(attr "<STEP Offsets>" "X=-4.47;Y=-4.31;Z=0.1")
