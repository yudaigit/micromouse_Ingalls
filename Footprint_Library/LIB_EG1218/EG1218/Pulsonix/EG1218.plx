...
//12863335/1485246/2.50/3/2/Switch
...
(library Library_1
	...
	(compDef "EG1218" (originalName "EG1218") (compHeader (numPins 3) (numParts 1) (refDesPrefix S)
		...
		(attr "Description" "SLIDE, 200mA, 30VDC SPDT, On-On Through Hole")
		(attr "<Hyperlink>" "https://configured-product-images.s3.amazonaws.com/2D/specs/EG1218.pdf")
		(attr "<Component Height>" "7.4")
		(attr "<STEP Filename>" "EG1218.stp")
		(attr "<STEP Offsets>" "X=2.5;Y=0;Z=0.87")
